  ...
  return (
    <Container className="flex items-center justify-center min-h-screen py-8">
      <Card padding="xl" className="text-center max-w-2xl w-full">
        ...
        <div className="badge mb-10">Photos don&apos;t get uploaded anywhere</div>
        ...
        >
          ...
          <p className="text-xl font-semibold text-ink mb-2">Upload Photo</p>
          <p className="text-sm text-neutral-medium">Click to select or drag and drop</p>
        </div>
        ...
        <div className="bg-primary-light rounded-2xl p-5 text-left mb-6">
          <p className="text-sm text-ink leading-relaxed">
            <span className="font-semibold">Pro tip:</span> Use good lighting and a simple
