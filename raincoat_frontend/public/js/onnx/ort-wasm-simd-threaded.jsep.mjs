var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var Lc = {
      ...
      850183: () => 'undefined' !== typeof wasmOffsetConverter,
      850240: a => {
        B.jb('Abs', a, void 0);
      },
      850291: a => {
      ...
      854500: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t) => {
      ...
      854901: (a, b, c, d, f, g, k, l, p, n, r, x, y, h) => {
        B.jb('ConvTranspose', a, {
          format: l ? 'NHWC' : 'NCHW',
          autoPad: b,
      ...
      855466: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t) => {
        B.jb('ConvTranspose', a, {
          format: p ? 'NHWC' : 'NCHW',
          autoPad: b,
          dilations: [c],
      ...
      855867: (a, b, c, d, f, g, k, l, p, n, r, x, y, h) => {
        B.jb('ConvTranspose', a, {
          format: l ? 'NHWC' : 'NCHW',
          autoPad: b,
          dilations: Array.from(z().subarray(c >>> 0, ((c >>> 0) + 2) >>> 0)),
      ...
      856523: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('AveragePool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      856898: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('AveragePool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      857269: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('MaxPool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      857636: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('MaxPool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      860739: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('Conv', a, {
          format: x ? 'NHWC' : 'NCHW',
          auto_pad: b,
      ...
      862247: (a, b) => B.$b(a, b, B.Eb.bc, B.Eb.errors),
      862359: (a, b, c) => {
        B.jb('SkipLayerNormalization', a, { epsilon: b, simplified: !!c });
      },
    };
    ...
    function ob(a, b, c, d) {
      ...
      if ('undefined' == typeof SharedArrayBuffer)
        return (
          H('Current environment does not support SharedArrayBuffer, pthreads are not available!'),
          6
        );
      var f = [];
        ...
        toWireType: function (d, f) {
          ...
          if (c && g) od(f, p, k + 1);
            ...
            for (g = 0; g < k; ++g) {
              ...
              if (255 < n)
                throw (X(p), new R('String has UTF-16 code units that do not fit in 8 bits'));
              w()[(p + g) >>> 0] = n;
            }
    ...
    function $d(a) {
      if (!I) {
        if (0 === Z) {
          ...
          2 === Z ? ((Z = 0), Od(ce), X(F), (F = null), Xd.forEach(Hd)) : db(`invalid state: ${Z}`);
        return Sd;
      }
    }
    function Mc(a) {
    ...
    function Jc(a, b, c, d) {
      ...
      n = {
        ...
        '%V': h => {
          ...
          if (t)
            53 == t && ((v = (h.ub + 371 - h.Bb) % 7), 4 == v || (3 == v && le(h.Cb)) || (t = 1));
          else {
            t = 52;
    ...
    var Ia = () => (Ia = Y.fb)(),
      ...
      ae = a => (ae = Y.yb)(a),
      ce = () => (ce = Y.zb)();
    B.___start_em_js = 862461;
    B.___stop_em_js = 862683;
    function De() {
      var a = Y;
      a = Object.assign({}, a);
      var b = d => f => d(f) >>> 0,
      ...
      0 < $a ||
        (E
          ...
          : (cd(Xa),
            0 < $a ||
              Ee ||
              ((Ee = !0), (B.calledRun = !0), I || (E || cd(Ya), na(B), E || cd(Za)))));
    }
    Ge();
    moduleRtn = pa;
