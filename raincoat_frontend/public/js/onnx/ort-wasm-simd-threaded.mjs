var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var Rb = {
      ...
      822473: () => 'undefined' !== typeof wasmOffsetConverter,
    };
    function Ta() {
    ...
    function Va(a, b, c, d) {
      ...
      if ('undefined' == typeof SharedArrayBuffer)
        return (
          I('Current environment does not support SharedArrayBuffer, pthreads are not available!'),
          6
        );
      var f = [];
    ...
    function Pb(a, b, c, d) {
      ...
      v = {
        ...
        '%V': e => {
          ...
          if (p)
            53 == p && ((t = (e.Qa + 371 - e.Sa) % 7), 4 == t || (3 == t && X(e.Ta)) || (p = 1));
          else {
            p = 52;
    ...
    var wa = (a, b, c, d, f, h) => (wa = Z.Ga)(a, b, c, d, f, h),
      ...
      ac = a => (ac = Z.Oa)(a),
      $b = () => ($b = Z.Pa)();
    w.___start_em_js = 822530;
    w.___stop_em_js = 822591;
    function Lc() {
      var a = Z;
      a = Object.assign({}, a);
      var b = d => () => d() >>> 0,
      ...
      0 < O ||
        (C
          ...
          : (jc(Ga),
            0 < O ||
              Mc ||
              ((Mc = !0), (w.calledRun = !0), Fa || (C || jc(Ha), ha(w), C || jc(Ia)))));
    }
    Oc();
    moduleRtn = ia;
